...
export default function AdminServiceDetailPage() {
  ...
  // Shell-aware base path so Edit buttons stay inside the current portal.
    ...
    return (
      <div>
        <PageHeader title="Service" subtitle="Detail" action={
          <Button variant="subtle" onClick={() => router.push(servicesBase)}>← Back</Button>
        } />
      ...
      <PageHeader
        ...
        action={
          <div className="flex gap-2">
            <Button variant="subtle" onClick={() => router.push(servicesBase)}>← Back</Button>
            <Button variant="subtle" onClick={() => router.push(`${servicesBase}/${id}/edit`)}>✎ Edit</Button>
          </div>
        }
      />
        ...
        <div className="space-y-4">
          ...
          <Card title="Actions">
            <div className="flex flex-col gap-2">
              ...
              <button
                onClick={() => router.push(`${servicesBase}/${id}/edit`)}
