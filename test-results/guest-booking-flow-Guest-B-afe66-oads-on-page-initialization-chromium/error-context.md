...
- Name: guest-booking-flow.spec.js >> Guest Booking Flow - Complete Journey >> Redux Guest State Management >> GBF-008: Redux state loads on page initialization
- Location: tests/e2e/guest-booking-flow.spec.js:184:9
