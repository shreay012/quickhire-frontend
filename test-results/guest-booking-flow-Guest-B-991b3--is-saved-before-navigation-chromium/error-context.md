...
- Name: guest-booking-flow.spec.js >> Guest Booking Flow - Complete Journey >> Guest Authentication & Redirect Handling >> GBF-006: Guest pending booking data is saved before navigation
- Location: tests/e2e/guest-booking-flow.spec.js:136:9
