...
- Name: guest-booking-flow.spec.js >> Guest Booking Flow - Complete Journey >> Guest Booking Steps Validation >> GBF-001: Guest can navigate to booking page without redirect
- Location: tests/e2e/guest-booking-flow.spec.js:19:9
